...
void *AtenderCliente (void *socket)
{
	...
	while (terminar == 0)
	{
		...
		else if (codigo == 4) // Verificar si el nombre es pal￭ndromo
		{
			...
			if (es_palindromo)
				sprintf(respuesta, "4/%d/%s es un pal￭ndromo", numForm, nombre);
			else
				sprintf(respuesta, "4/%d/%s no es un pal￭ndromo", numForm, nombre);
		}
		...
		// Si la solicitud es c￳digo 1, 2, 3, 4 o 5, aumentamos el contador
